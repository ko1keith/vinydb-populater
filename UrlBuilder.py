...
class UrlBuilder():
    ...
    def getUrlArtist(self, strArtist):
        url = self.urlLastFM + "?method=artist.gettopalbums&api_key=4f59be03f16c37082901e7e0fc64fc5a&artist=" + strArtist  + "&format=json"
        return url

    # Build list of queries for multiple albums
    def getUrls(self, dictAlbumArtist):
        pass

    # Build url to create new album document in MongoDB
